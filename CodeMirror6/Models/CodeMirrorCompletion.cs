...
/// </summary>
public record CodeMirrorCompletion
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("displayLabel")] public string? DisplayLabel { get; init; }
    ...
    /// </summary>
    [JsonPropertyName("boost")] public int? Boost { get; init; }
    ...
    /// </summary>
    [JsonPropertyName("section")] public CodeMirrorCompletionSection? Section { get; init; }
}

/// <summary>
/// Represents a section of CodeMirror completion items.
/// </summary>
public record CodeMirrorCompletionSection
{
    /// <summary>
