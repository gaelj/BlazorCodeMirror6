import { i as indentNodeProp, c as continuedIndent, f as foldNodeProp, s as styleTags, t as tags, L as LRLanguage, a as LanguageSupport, E as ExternalTokenizer, b as LRParser, d as ifNotIn, e as completeFromList, g as syntaxTree } from './index-9srO0oxQ.js';
...
class CompletionLevel {
    ...
    addNamespace(namespace, plainScope = this) {
        if (Array.isArray(namespace)) {
            ...
            this.addNamespaceObject(namespace, plainScope);
        }
    }
    addNamespaceObject(namespace, plainScope) {
...
function completeFromSchema(schema, tables, schemas, defaultTableName, defaultSchemaName, dialect) {
    ...
    if (defaultTableName)
        top.addCompletions(defaultSchema.child(defaultTableName).list);
    return (context) => {
